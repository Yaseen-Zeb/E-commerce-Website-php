					...
					<div class="wrap-contacts ">
						<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
							<div class="contact-box contact-form">
								...
								<form action="#" name="frm-contact" class="contact_fom form">
                                    ...
                                    <div style="display:none;" class="alert alert-success cantact_success">ssss</div>
                                    <div style="display:none;" class="alert alert-danger cantact_error">ddd</div>
									<input type="submit" name="ok" value="Submit" onclick="contact_form_submit()" >
