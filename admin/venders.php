...
if (isset($_GET["operation"]) && isset($_GET["id"])) {
   ...
   if ($_GET["operation"] == "active" || $_GET["operation"] == "deactive") {
    $obj->update("admin",["status" => $status],"id = $id");
   $obj->getResult();
...
<div class="admin-content-container">
    <div style="display: flex;align-items: flex-start;justify-content: space-between; margin-bottom:20px;" >
        <h1>Categries</h1>
        <a class="btn btn-success" href="manage_venders.php">Add Vender/Admin</a>
    </div>
        ...
        <thead class="thead-inverse">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo ($row["role"]==1)? "Admin":"Vender" ?></td>
                    ...
                    <td>
                    <a href="manage_venders.php?id=<?php echo $row["id"] ?>" class="fa fa-edit"></a> 
