...
if (isset($_GET["operation"]) && isset($_GET["id"])) {
   ...
   if ($_GET["operation"] == "active" || $_GET["operation"] == "deactive") {
    $obj->update("size",["status" => $status],"id = $id");
   $obj->getResult();
...
<div class="admin-content-container">
    <div style="display: flex;align-items: flex-start;justify-content: space-between; margin-bottom:20px;" >
        <h1>Sizes</h1>
        <a class="btn btn-success" href="manage_size.php">Add Size</a>
    </div>
        ...
        <thead class="thead-inverse">
            ...
            <tbody>
                ...
                <td><?php echo $row["id"] ?></td>
                    ...
                    <td>
                    <a href="manage_size.php?id=<?php echo $row["id"] ?>" class="fa fa-edit"></a> 
